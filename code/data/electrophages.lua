...
data:extend({
	{
		type = "technology",
		name = "electrophages",
		icon = "__FulgoraLives__/graphics/from_biochemistry/electrophage_tech.png",
		icon_size = 256,
		effects = {
			{
				type = "unlock-recipe",
	...
	},
	{
		...
		icon = "__FulgoraLives__/graphics/from_biochemistry/electrophage-cultivation.png",
	...
	},
	{
		...
		icons = {
			...
			{
				icon = "__FulgoraLives__/graphics/batteries/holmium_battery_short_charged.png",
				scale = 0.3,
				shift = {7, 7},
			},
		},
	...
	},
	{
		type = "item",
		name = "electrophage",
		icon = "__FulgoraLives__/graphics/from_biochemistry/electrophage.png",
		pictures = {
			{ size = 64, filename = "__FulgoraLives__/graphics/from_biochemistry/electrophage.png",   scale = 0.5, mipmap_count = 4 },
			{ size = 64, filename = "__FulgoraLives__/graphics/from_biochemistry/electrophage-1.png", scale = 0.5, mipmap_count = 4 },
			{ size = 64, filename = "__FulgoraLives__/graphics/from_biochemistry/electrophage-2.png", scale = 0.5, mipmap_count = 4 },
			{ size = 64, filename = "__FulgoraLives__/graphics/from_biochemistry/electrophage-3.png", scale = 0.5, mipmap_count = 4 },
		},
		subgroup = "fulgora-processes",
